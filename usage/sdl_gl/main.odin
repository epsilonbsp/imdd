...
main :: proc() {
    ...
    loop: for {
        ...
        // imdd3.draw_circle({}, camera.forward, camera.right, 4, 0xff0000ff)

        // imdd3.draw_stroke({}, {0, 128, 0}, {0, 0, -1}, {1, 0, 0}, 4, 0xff0000ff)
        // imdd3.draw_stroke({}, {0, 128, 0}, camera.forward, camera.right, 4, 0xff0000ff)
        ...
        // imdd3.draw_ring({0, 0, -128}, {0, 0, -1}, {1, 0, 0}, 64, 2, 0x4963e6ff)
        ...
        // imdd3.draw_stroke_arrow({}, {0, 128, 0}, camera.forward, camera.right, 8, 16, 0x00ff00ff)
        ...
        // imdd3.draw_wire_aabb({-192, 32, -128}, {64, 64, 64}, 0xebbe60_ff)
        // imdd3.draw_wire_cylinder_aa({-64, 32, -128}, {32, 64}, 0x9fe685_ff)
