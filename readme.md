...
draw_cone_o :: proc(position: [3]f32, size: [2]f32, rotation: quaternion128, color: u32)
...
draw_cone_frustum_o :: proc(position: [3]f32, size: [2]f32, top_radius: f32, rotation: quaternion128, color: u32)
...
draw_capsule_o :: proc(position: [3]f32, size: [2]f32, rotation: quaternion128, color: u32)
...
draw_wire_arrow :: proc(point0: [3]f32, point1: [3]f32, width: f32, head_size: f32, color: u32, wire_color: u32 = 0)
